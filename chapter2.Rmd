...
As common sense suggests, _attitude_ shows the strongest correlation with _points_. The effect is statistically significant at the highest level. Age and surface learning also exert an effect, but their respective effects do not reach the required .05 level of statistical significance. It is very important to note, however, that _attitude_ comes much closer to statistical significance than _surf_ even though the absolute value of its regression coefficient is much smaller. What's going on? 
